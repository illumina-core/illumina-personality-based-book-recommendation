...
from mongoengine import Document, EmbeddedDocument, EmbeddedDocumentList
...
class Books(Document):
    ...
    cover_image = StringField(required=True)
    ...
    reviews = EmbeddedDocumentList(EmbeddedDocumentField(Reviews), ordering="created", reverse=True)
...
class Users(Document):
    ...
    shelves = EmbeddedDocumentList(EmbeddedDocumentField(Shelves), default=[
        Shelves(
