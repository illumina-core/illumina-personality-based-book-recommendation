                ...
                <div className="container-fluid" style={{backgroundColor:'#fff', paddingTop:'50px'}}>
                    ...
                    <div className="container-fluid mx-auto" style={{width:'80%'}}>
                        <div className="row card" style={{border:'3.5px solid #151B2D'}}>
                            <img className="card-img-top" src="./static/images/bko2.jpg" alt="Card  cap" style={{width:'100%'}}/>
                        ...
                        <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    <img className="d-block w-100" src="./static/images/carousel1.png" alt="First slide" />
                                </div>
                                <div className="carousel-item">
                                    <img className="d-block w-100" src="./static/images/carousel2.png" alt="Second slide" />
                                </div>
                            </div>
                        ...
                        <div className="container-fluid mx-auto" style={{width:'80%', paddingLeft:'0px', paddingRight:'0px', paddingTop:'60px', backgroundColor:'#fff'}}> 
                            ...
                            <div className="card-deck" style={{paddingTop:'20px', paddingBottom:'20px'}}>
                                <div className="card">
                                    ...
                                    <img className="card-img-top" width="100%" src="./static/images/genre_adventure.jpg" alt="Card  cap" style={{border:'3px solid #151B2D'}}/>
                                    </Link>
                                </div>
                                <div className="card">
                                    <Link to='/search?genre=Science%20Fiction'>
                                    <img className="card-img-top" width="100%"  src="./static/images/genre_sf1.jpg" alt="Card  cap" style={{border:'3px  solid #151B2D'}}/>
                                    </Link>
                                </div>
                                <div className="card">
                                    <Link to='/search?genre=History'>
                                    <img className="card-img-top" width="100%"  src="./static/images/genre_history.jpg" alt="Card  cap" style={{border:'3px  solid #151B2D'}}/>
                                    </Link>
                                </div>
                            </div>
                            <div className="card-deck">
                                <div className="card">
                                    ...
                                    <img className="card-img-top" width="100%" src="./static/images/genre_fantasy.jpg" alt="Card  cap" style={{border:'3px solid #151B2D'}}/>
                                    </Link>
                                </div>
                                <div className="card">
                                    <Link to='/search?genre=Poetry'>
                                    <img className="card-img-top" width="100%"  src="./static/images/genre_poetry.jpg" alt="Card  cap" style={{border:'3px  solid #151B2D'}}/>
                                    </Link>
                                </div>
                                <div className="card">
                                    <Link to='/search?genre=Graphic%20Novels'>
                                    <img className="card-img-top" width="100%"  src="./static/images/genre_gn.jpg" alt="Card  cap" style={{border:'3px  solid #151B2D'}}/>
                                    </Link>
                                </div>
                            </div>
